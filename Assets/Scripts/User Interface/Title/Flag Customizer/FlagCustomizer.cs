...
namespace TitleUI
{
    public class FlagCustomizer : TitleSlave
    {
        public FlagEditingArea editingArea;
        ...
        void SaveFlag()
        {
            ...
            BattleTweaker.flags[editingArea.currentPlayer] = flag;
        }

        public override void Next()
        {
            SaveFlag();
            if (editingArea.currentPlayer == 1 || BattleTweaker.aiOpponent) base.Next();
            else
            {
